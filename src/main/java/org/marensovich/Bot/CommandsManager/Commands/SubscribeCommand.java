    ...
    public void execute(Update update) {
        ...
        String reply = """
                * Здравствуйте! \uD83C\uDF89  *
                ...
                Она даст вам доступ к созданию карт с точками, где расположены ДПС (до 10 в день), позволяя максимально эффективно использовать все функции бота и получать больше пользы. \s
                
                \uD83D\uDE80 *Premium-подписка* — всего за 999 рублей. \s
                Это расширенный пакет с доступом к созданию карт с точками, где расположены ДПС (до 15 в день), который откроет перед вами дополнительные возможности и обеспечит лучший опыт работы с ботом. \s
