...
public class LangTrTrHandler implements TelegramCallbackHandler {
    @Override
    public String getCallbackData() {
        return SettingsCommand.CALLBACK_LANG_TR_TR;
    }
    ...
    public void handle(Update update) throws TelegramApiException {
        ...
        if (command != null) {
            command.handleOptionSelected(update, "lang", "tr_TR");
        }
    }
}
